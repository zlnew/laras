...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('penagihan', function (Blueprint $table) {
            ...
            $table->decimal('potongan_lainnya2', 20, 2)->nullable();
            $table->decimal('potongan_lainnya3', 20, 2)->nullable();
            $table->text('keterangan_potongan_lainnya')->nullable();
            $table->text('keterangan_potongan_lainnya2')->nullable();
            $table->text('keterangan_potongan_lainnya3')->nullable();
