          ...
          <div class="flex flex-wrap mt-0 -mx-3">
            ...
            <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 md:w-6/12">
              <div class="absolute top-0 hidden w-3/5 h-full -mr-32 -right-40 md:block">
                <div style="background-image: url('/storage/background/login_bg.webp');" class="absolute inset-x-0 top-0 z-0 h-full -ml-16 bg-cover overflow-hidden -skew-x-10 rounded-bl-xl"></div>
                  <img src="/storage/logo/logo.webp" class="absolute w-1/2 bg-white p-2 bottom-20 mr-40 right-40" alt="Laras Sembada Logo">
