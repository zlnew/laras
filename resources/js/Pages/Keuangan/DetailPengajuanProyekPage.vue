...
import type { ApprovedPengajuanSaatIni } from '@/Components/Keuangan/PengajuanDana/PengajuanDanaItem/PengajuanProyekItemTable.vue'
...
const breadcrumbs = [
  { label: 'Keuangan', url: '#' },
  { label: 'Pengajuan Proyek', url: route('pengajuan_dana_proyek') },
...
<template>
  ...
  <layout>
    ...
    <module-top-section
      ...
      timeline-title="Timeline Pengajuan Proyek"
      :data="{
