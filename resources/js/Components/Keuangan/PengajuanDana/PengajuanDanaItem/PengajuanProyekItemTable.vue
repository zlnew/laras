...
import { type FormOptions } from '@/Pages/Keuangan/DetailPengajuanProyekPage.vue'

// comps
import {
  PengajuanProyekItemCreateDialog,
  PengajuanProyekItemEditDialog,
...
function createPengajuanDanaItem () {
  $q.dialog({
    component: PengajuanProyekItemCreateDialog,
    componentProps: {
...
function editPengajuanDanaItem (data: DetailPengajuanDana) {
  $q.dialog({
    component: PengajuanProyekItemEditDialog,
    componentProps: {
