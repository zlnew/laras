...
// comps
import {
  PengajuanProyekSearchDialog,
  PengajuanProyekCreateDialog,
  PengajuanProyekEditDialog,
...
function searchPengajuanDana () {
  $q.dialog({
    component: PengajuanProyekSearchDialog,
    componentProps: {
...
function createPengajuanDana () {
  $q.dialog({
    component: PengajuanProyekCreateDialog,
    componentProps: {
      options: props.formOptions
    }
  }).onOk((payload) => {
...
function editPengajuanDana (data: PengajuanDana) {
  $q.dialog({
    component: PengajuanProyekEditDialog,
    componentProps: {
      pengajuanDana: data,
      options: props.formOptions
    }
    ...
    >
      ...
      <template v-slot:top-right>
        <q-btn
          ...
          icon="clear"
          color="secondary"
          @click="router.visit(route('pengajuan_dana_proyek'))"
        />
        <q-btn
          flat
          no-caps
