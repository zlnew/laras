...
import type { FormOptions } from '@/Pages/Laporan/LaporanPengajuanProyekPage.vue'

// comps
import { LaporanPengajuanProyekSearchDialog } from '@/Components/Laporan/laporan-page'
...
function search () {
  $q.dialog({
    component: LaporanPengajuanProyekSearchDialog,
    componentProps: {
      ...
      <template v-slot:top-right>
        <div class="q-gutter-sm">
          <q-btn
            ...
            icon="clear"
            color="secondary"
            @click="router.visit(route('laporan.pengajuan_proyek'))"
          />
          ...
          <q-btn
              ...
              @click="excelParser().exportDataFromJSON({
                data: excelTable,
                name:'pengajuan-proyek', type: 'xls'
              })"
            >
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td
            key="tahun_anggaran"
            :props="props"
            @click.prevent="router.visit(route('detail_pengajuan_dana_proyek', props.row.id_pengajuan_dana))"
          ...
          <q-td key="status" :props="props">
            ...
            <Link :href="route('detail_pengajuan_dana_proyek', props.row.id_pengajuan_dana)">
              <q-badge
