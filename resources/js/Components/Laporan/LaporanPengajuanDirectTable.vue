...
import type { FormOptions } from '@/Pages/Laporan/LaporanPengajuanDirectPage.vue'

// comps
import { LaporanPengajuanDirectSearchDialog } from '@/Components/Laporan/laporan-page'
...
function search () {
  $q.dialog({
    component: LaporanPengajuanDirectSearchDialog,
    componentProps: {
...
<template>
  <div class="q-pa-md">
    <q-table
      ...
      bordered
      row-key="id_rab"
      title="Laporan Pengajuan Direct"
      :rows="rows"
      :columns="columns"
      ...
      <template v-slot:top-right>
        <div class="q-gutter-sm">
          <q-btn
            ...
            icon="clear"
            color="secondary"
            @click="router.visit(route('laporan.pengajuan_direct'))"
          />
