...
const form = useForm({
  setoran_modal_pic: null,
  setoran_modal_pengguna_jasa: null
})
  ...
  >
    <q-card style="width: 400px; max-width: 80vw;">
      <q-card-section class="row items-center q-pb-none">
        <div class="text-h6">Pencarian Setoran Modal</div>
        <q-space />
        <q-btn
          flat
          round
        ...
        <q-card-section class="scroll">
          <div class="q-gutter-md">
            <q-select
              ...
              v-model="form.setoran_modal_pic"
              option-value="id"
              option-label="name"
            ...
            <q-select
              ...
              input-debounce="500"
              label="Pengguna jasa"
              v-model="form.setoran_modal_pengguna_jasa"
