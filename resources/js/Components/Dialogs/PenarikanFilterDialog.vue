  ...
  >
    <q-card style="width: 400px; max-width: 80vw;">
      <q-card-section class="row items-center q-pb-none">
        <div class="text-h6">Pencarian Penarikan</div>
        <q-space />
        <q-btn
          flat
          round
        ...
        <q-card-section class="scroll">
          <div class="q-gutter-md">
            ...
            <q-select
              ...
              input-debounce="500"
              label="Pengguna jasa"
              v-model="form.penarikan_pengguna_jasa"
