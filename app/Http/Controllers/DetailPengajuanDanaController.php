...
{
    public function proyek(PengajuanDana $pengajuanDana): Response
    {         
        ...
        return Inertia::render('Keuangan/DetailPengajuanProyekPage', [
    ...
    public function direct(PengajuanDana $pengajuanDana): Response
    {         
        $pengajuanDana = DB::table('pengajuan_dana')
            ->leftJoin('proyek', 'proyek.id_proyek', '=', 'pengajuan_dana.id_proyek')
            ->leftJoin('users', 'users.id', '=', 'proyek.id_user')
        ...
        return Inertia::render('Keuangan/DetailPengajuanDirectPage', [
            'pengajuanDana' => $pengajuanDana,
            'detailPengajuanDana' => $detailPengajuanDana,
            'dokumenPenunjang' => $dokumenPenunjang,
            'evaluasi' => $evaluasi,
